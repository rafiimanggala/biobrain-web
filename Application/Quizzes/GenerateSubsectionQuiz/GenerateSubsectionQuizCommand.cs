...
namespace Biobrain.Application.Quizzes.GenerateSubsectionQuiz
{
    [PublicAPI]
    public class GenerateSubsectionQuizCommand : ICommand<GenerateSubsectionQuizCommand.Result>
    {
        ...
        internal class Validator : ValidatorBase<GenerateSubsectionQuizCommand>
        {
        ...
        internal class PermissionCheck : PermissionCheckBase<GenerateSubsectionQuizCommand>
        {
            public PermissionCheck(ISecurityService securityService) : base(securityService)
            {
            }

            protected override bool CanExecute(GenerateSubsectionQuizCommand request, IUserSecurityInfo user) => user.IsAccountOwner(request.UserId);
        }


        internal class Handler : CommandHandlerBase<GenerateSubsectionQuizCommand, Result>
        {
            ...
            public override async Task<Result> Handle(GenerateSubsectionQuizCommand request, CancellationToken cancellationToken)
            {
